      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <motion.button
            ...
            whileTap={{ scale: 0.94 }}
            onClick={onClick}
            className="fixed bottom-20 md:bottom-6 right-6 z-[60] w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-accent shadow-lg shadow-primary/30 flex-center relative overflow-hidden animate-glow-pulse"
