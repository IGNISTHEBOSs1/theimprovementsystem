  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="glass-strong rounded-2xl p-4 border border-secondary/30 glow-secondary flex items-center gap-4 min-w-[200px]">
            {/* Progress circle */}
            <div 
            ...
            <div className="flex-1 cursor-pointer" onClick={onExpand}>
              ...
              <p className="text-xs text-muted-foreground">
                {state.isRunning ? 'Focus Mode' : 'Paused'}
              </p>
            </div>
