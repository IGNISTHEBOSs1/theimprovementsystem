...
export const MotivationQuote = ({ section }: MotivationQuoteProps) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground italic flex-1">"{quote}"</p>
      <button onClick={refreshQuote} className="text-muted-foreground hover:text-primary transition-colors shrink-0">
