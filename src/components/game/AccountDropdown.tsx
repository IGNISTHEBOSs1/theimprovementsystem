...
export const AccountDropdown = ({ profile, onEditProfile }: AccountDropdownProps) => {
  ...
  const rarity = avatar; // color/border/glow from AVATAR_OPTIONS
    ...
    <>
      <div className="relative overflow-visible">
        <motion.button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-primary/30 hover:bg-white/8 transition-all"
        >
          ...
          {isOpen && (
            <>
              ...
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-80 glass-strong border border-white/12 rounded-2xl overflow-hidden z-[100] shadow-2xl shadow-black/60"
              >
                {/* Profile Banner */}
                <div className="relative overflow-hidden">
                  ...
                  <div className="relative p-5 flex items-center gap-4">
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      <div className={`absolute -bottom-1.5 left-1/2 -translate-x-1/2 px-2 py-0.5 rounded-full text-[9px] font-bold bg-background border border-white/10 whitespace-nowrap ${rarity.color}`}>
                        {rarity.label}
                      </div>
                    </div>
                    {/* Info */}
