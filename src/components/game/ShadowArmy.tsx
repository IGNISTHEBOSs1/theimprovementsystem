                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <span className={cn('font-display font-bold text-xs', unlk ? 'text-foreground' : 'text-muted-foreground/50')}>
                            {shadow.name}
                          </span>
                          <span className={cn('text-[9px] font-bold uppercase', unlk ? style.color : 'text-muted-foreground/30')}>
                            {style.label}
                          </span>
                        </div>

                        {unlk ? (
                          <p className="text-[10px] text-muted-foreground">{shadow.bonusDesc}</p>
                        ) : (
                          <div>
                            <p className="text-[10px] text-muted-foreground/50 mb-1">🔒 {shadow.unlockCond}</p>
