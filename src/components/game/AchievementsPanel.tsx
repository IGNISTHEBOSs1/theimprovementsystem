...
export const AchievementsPanel = ({ achievements, unlockedCount, totalCount }: AchievementsPanelProps) => {
  ...
  useEffect(() => {
    ...
    const onWheel = (e: WheelEvent) => {
      ...
      setZoom(prev => Math.min(2.5, Math.max(0.35, prev + delta)));
    };
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ height: 480, cursor: isDragging ? 'grabbing' : 'grab', background: 'radial-gradient(ellipse at 50% 0%, hsl(var(--primary)/0.06) 0%, transparent 70%)', userSelect: 'none', WebkitUserSelect: 'none' as any, touchAction: 'none' }}
