  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className={cn(
            "glass-strong rounded-2xl p-4 border border-secondary/30 flex items-center gap-3 min-w-[200px] relative transition-all duration-300",
            state.isRunning && "animate-glow-pulse"
          )}>
