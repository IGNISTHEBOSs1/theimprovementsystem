...
export const RewardCenter = ({ credits, totalQuestsCompleted, level, onSpend }: RewardCenterProps) => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-2xl border border-white/10 overflow-hidden hover:border-accent/20 transition-all duration-250 top-light" style={{ boxShadow: "var(--shadow-card)" }}>
      {/* Header */}
