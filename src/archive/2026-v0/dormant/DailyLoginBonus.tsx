      ...
      {isVisible && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={{ scale: 0.8, y: 50 }}
            className="relative w-full max-w-md glass-strong rounded-2xl border border-primary/40 overflow-hidden"
          ...
          >
            ...
            <div className="relative p-6 text-center">
              ...
              >
                ...
                <p className="text-body-sm text-muted-foreground mt-1 font-jp">デイリーログインボーナス</p>
              </motion.div>
