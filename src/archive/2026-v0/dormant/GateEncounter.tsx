        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              defeated ? 'border-green-500/40 shadow-[0_0_20px_rgba(34,197,94,0.15),0_2px_12px_rgba(0,0,0,0.5)]' :
              unlocked ? 'border-white/8 hover:border-primary/30 hover:shadow-[var(--shadow-glow-primary)] top-light' :
