...
const achievementDefinitions: Omit<Achievement, 'unlocked' | 'unlockedAt'>[] = [
  ...
  { id: 'perfect_being', name: 'Perfect Being', description: 'All stats at 100', icon: '✨', category: 'special', rarity: 'mythic', condition: (s) => Object.values(s.stats).every(v => v.level >= 100) },
  ...
  { id: 'stat_max', name: 'Transcendence', description: 'Max out any stat to 100', icon: '✨', category: 'special', rarity: 'legendary', condition: (s) => Object.values(s.stats).some(v => v.level >= 100) },
  { id: 'all_stats_80', name: 'Elite Hunter', description: 'All stats above 80', icon: '🦅', category: 'special', rarity: 'legendary', condition: (s) => Object.values(s.stats).every(v => v.level >= 80) },
  ...
  { id: 'stat_80', name: 'Specialist', description: 'Reach 80 in any stat', icon: '📊', category: 'special', rarity: 'epic', condition: (s) => Object.values(s.stats).some(v => v.level >= 80) },
  { id: 'stat_all_60', name: 'Balanced Warrior', description: 'All stats above 60', icon: '⚖️', category: 'special', rarity: 'epic', condition: (s) => Object.values(s.stats).every(v => v.level >= 60) },
  ...
  { id: 'fitness_focus', name: 'Fitness Focused', description: 'Reach 70 in Fitness stat', icon: '💪', category: 'special', rarity: 'epic', condition: (s) => s.stats.FIT.level >= 70 },
  { id: 'intellect_peak', name: 'Intellect Peak', description: 'Reach 70 in Intelligence stat', icon: '🧠', category: 'special', rarity: 'epic', condition: (s) => s.stats.INT.level >= 70 },
  { id: 'social_butterfly', name: 'Social Butterfly', description: 'Reach 70 in Social stat', icon: '🦋', category: 'special', rarity: 'epic', condition: (s) => s.stats.SOC.level >= 70 },
  { id: 'discipline_iron', name: 'Iron Discipline', description: 'Reach 70 in Discipline stat', icon: '🔒', category: 'special', rarity: 'epic', condition: (s) => s.stats.DIS.level >= 70 },
  { id: 'focus_laser', name: 'Laser Focus', description: 'Reach 70 in Focus stat', icon: '🎯', category: 'special', rarity: 'epic', condition: (s) => s.stats.FOC.level >= 70 },
  { id: 'finance_guru', name: 'Finance Guru', description: 'Reach 70 in Finance stat', icon: '📈', category: 'special', rarity: 'epic', condition: (s) => s.stats.FIN.level >= 70 },
  ...
  { id: 'stat_60', name: 'Skilled', description: 'Reach 60 in any stat', icon: '📊', category: 'special', rarity: 'rare', condition: (s) => Object.values(s.stats).some(v => v.level >= 60) },
  { id: 'stat_all_50', name: 'Well Rounded', description: 'All stats above 50', icon: '⭐', category: 'special', rarity: 'rare', condition: (s) => Object.values(s.stats).every(v => v.level >= 50) },
  ...
  { id: 'fitness_boost', name: 'Fitness Boost', description: 'Reach 55 in Fitness', icon: '🏋️', category: 'special', rarity: 'rare', condition: (s) => s.stats.FIT.level >= 55 },
  { id: 'mind_sharp', name: 'Sharp Mind', description: 'Reach 55 in Intelligence', icon: '💡', category: 'special', rarity: 'rare', condition: (s) => s.stats.INT.level >= 55 },
  { id: 'social_skills', name: 'Social Skills', description: 'Reach 55 in Social', icon: '🤝', category: 'special', rarity: 'rare', condition: (s) => s.stats.SOC.level >= 55 },
  { id: 'self_control', name: 'Self Control', description: 'Reach 55 in Discipline', icon: '🧘', category: 'special', rarity: 'rare', condition: (s) => s.stats.DIS.level >= 55 },
  { id: 'concentration', name: 'Concentration', description: 'Reach 55 in Focus', icon: '🔍', category: 'special', rarity: 'rare', condition: (s) => s.stats.FOC.level >= 55 },
  { id: 'money_sense', name: 'Money Sense', description: 'Reach 55 in Finance', icon: '💹', category: 'special', rarity: 'rare', condition: (s) => s.stats.FIN.level >= 55 },
  ...
  { id: 'stat_55', name: 'Above Average', description: 'Reach 55 in any stat', icon: '📈', category: 'special', rarity: 'uncommon', condition: (s) => Object.values(s.stats).some(v => v.level >= 55) },
  ...
  { id: 'stat_improvement', name: 'Self Improvement', description: 'Improve any stat', icon: '📊', category: 'special', rarity: 'common', condition: (s) => Object.values(s.stats).some(v => v.level > 1) },
