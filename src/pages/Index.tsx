            ...
            {activeSection === 'gates' && (
              ...
              >
                ...
                <div className="max-w-4xl mx-auto">
                  <GateEncounter level={gameState.level} totalQuestsCompleted={gameState.totalQuestsCompleted} currentStreak={getCurrentStreak()} totalQuestsCompleted={gameState.totalQuestsCompleted} level={gameState.level} />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
