        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden fixed inset-x-3 top-[60px] z-40"
            >
              <div className="glass-strong rounded-2xl border border-white/12 shadow-2xl shadow-black/50 overflow-hidden p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5">
                    <Button variant="ghost" size="icon" onClick={() => { playTap(); setShowAIAssistant(true); setMobileMenuOpen(false); }} className="w-8 h-8 rounded-lg">
                      <Bot className="w-4 h-4 text-primary" />
                    </Button>
                    <SoundToggle enabled={soundEnabled} onToggle={() => { playTap(); toggleSound(); }} />
                    <ThemeSwitcher currentAccent={accent} onAccentChange={(a) => { playTap(); setAccent(a); }} />
